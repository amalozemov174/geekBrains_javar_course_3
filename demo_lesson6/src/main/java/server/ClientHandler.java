            ...
            _executorService.execute(() -> {
             ...
             timeoutFuture = _executorService.submit(() -> {
                try {
                        ...
                        if(!authOk){
                            ChatLogger.logLogger.info("Time to connection is out...");
                    ...
                    ChatLogger.logLogger.info("Error creation client connection..." + e.getMessage());
        ...
        while (true){
            try {
                ...
                if(Command.isCommand(msg) && Command.getCommand(msg) == Command.CHANGENICK){
                    ...
                    ChatLogger.logLogger.info("Get message: " + msg);
